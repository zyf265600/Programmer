...
export class AppComponent implements AfterViewInit {
  ...
  namechunk = "aaaaaaaaaaaaaa bbbbbbbbbbbb cccccccccccc dddddddddd eeeeeeeeeee ffffffffffff gggggggggggg";
  ...
  angular-test/src/app/components/form/form.component.ts
}
