...
@NgModule({
  ...
  declarations: [AppComponent, 
    ...
    HoverDirective, StringchunckPipe, PersonComponent, ChildComponent, FormComponent, FormArrayComponent, FormBuilderComponent, FormCheckboxComponent, FormMethodComponent],
  // 声明当前模块依赖了哪些其他模块
