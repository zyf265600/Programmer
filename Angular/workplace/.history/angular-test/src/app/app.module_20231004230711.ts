...
import { StringchuckPipe } from './pipes/stringchuck.pipe';
import { StringchunckPipe } from './pipes/stringchunck.pipe';

// 调用 NgModule 装饰器, 告诉 Angular 当前类表示的是 Angular 模块
@NgModule({
  // 声明当前模块拥有哪些组件
  declarations: [AppComponent, ContentProjectionComponent, HoverDirective, StringchuckPipe, StringchunckPipe],
  // 声明当前模块依赖了哪些其他模块
