...
import { NgModule, reflectiveInject} from "@angular/core"
// 根组件
...
@NgModule({
  // 声明当前模块拥有哪些组件
  declarations: [AppComponent, ContentProjectionComponent, HoverDirective, StringchunckPipe, PersonComponent, ChildComponent],
  // 声明当前模块依赖了哪些其他模块
