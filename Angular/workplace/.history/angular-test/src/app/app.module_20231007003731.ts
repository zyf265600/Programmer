...
@NgModule({
  // 声明当前模块拥有哪些组件
  declarations: [AppComponent, ContentProjectionComponent, HoverDirective, StringchunckPipe, PersonComponent, ChildComponent, FormComponent, FormArrayComponent, FormBuilderComponent, FormCheckboxComponent, FormMethodComponent],
  // 声明当前模块依赖了哪些其他模块
