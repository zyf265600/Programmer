...
import { ComponentComponent } from './1_component_module/component/component.component';
...
@NgModule({
  ...
  declarations: [AppComponent,
    ...
    NotFoundComponent, HttpComponent, RouterComponent, NavigatorComponent, ComponentComponent, ModuleComponent],
  // 声明当前模块依赖了哪些其他模块
